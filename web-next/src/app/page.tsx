    ...
    <div dir="rtl" style={{ maxWidth: 900, margin: "0 auto", padding: "40px 20px" }}>
      {!selectedRole && (
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          >
            موقع توظيف مصري · واستشارات موارد بشرية
          </span>
          ...
          >
            🎉 التسجيل على الموقع مجاني ١٠٠٪ للجميع — سواء كنت بتدوّر على شغل أو بتدوّر على كوادر لشركتك
          </div>
        </div>
      )}
        ...
        <>
          ...
          <div style={{ maxWidth: 720, margin: "48px auto 0", padding: "0 16px", color: COLORS.inkSoft, fontSize: 14.5, lineHeight: 1.9 }}>
            <p style={{ marginBottom: 12 }}>
              "الشغل" موقع توظيف مصري مجاني بالكامل، هدفه إنه يسهّل رحلة الشغل على الطرفين. لو
            ...
            <p>
              مفيش رسوم اشتراك، مفيش عمولة على أي تقديم أو توظيف — الموقع مبني عشان يخدم سوق الشغل
              المصري ويقرّب المسافة بين اللي بيدوّر على شغل واللي بيدوّر على شغل عنده.
            </p>
          </div>
        </>
      ) : (
